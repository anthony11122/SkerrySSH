...
echo '@NET'
Get-CimInstance Win32_PerfRawData_Tcpip_NetworkInterface | Where-Object { $_.Name -ne 'Loopback' } | ForEach-Object { echo ($_.Name+': '+$_.BytesReceivedPersec+' '+$_.BytesSentPersec) }
echo '@PROC'
